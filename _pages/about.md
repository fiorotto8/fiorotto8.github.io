...
<section class="home-hero">
  <div class="home-hero__text">
    ...
    <p>Postdoctoral researcher at GSSI and Technical Coordinator of CYGNO04 at LNGS. In practice, this means moving between detector physics, clean-room work, simulation, commissioning, and the occasional cable with strong opinions.</p>
    <div class="hero-actions button-row">
      <a href="{{ base_path }}/research/" class="site-button site-button--primary">Explore research</a>
      <a href="{{ base_path }}/files/CV.pdf" class="site-button site-button--secondary">Download CV</a>
...
<section id="current-research">
  ...
  <p>From detector concept and simulation through construction, commissioning, and data analysis.</p>
  ...
  <div class="project-grid">
    ...
    <article class="project-card">
      ...
      <div class="project-card__body">
        ...
        <a href="{{ base_path }}/research/#cygno04" class="site-button site-button--secondary">Read more</a>
      </div>
    </article>
    ...
    <article class="project-card">
      ...
      <div class="project-card__body">
        ...
        <a href="{{ base_path }}/research/#xray-polarimetry" class="site-button site-button--secondary">Read more</a>
      </div>
    </article>
    ...
    <article class="project-card">
      ...
      <div class="project-card__body">
        ...
        <a href="{{ base_path }}/research/#new-rd" class="site-button site-button--secondary">Read more</a>
      </div>
    </article>
  </div>
</section>
...
<section id="earlier-programmes">
  ...
  <div class="earlier-programme">
    ...
    <p class="earlier-programme__text">Coordinated PICOSEC Micromegas R&amp;D for future muon-collider detector concepts. <a href="{{ base_path }}/research/#picosec">Read more</a></p>
  </div>

  <div class="earlier-programme">
    <h3 class="earlier-programme__title">CMS GEM detectors</h3>
    <p class="earlier-programme__text">Worked on CMS triple-GEM detectors from R&amp;D and quality control to Run 3 operations. <a href="{{ base_path }}/research/#cms-gem">Read more</a></p>
  </div>
</section>
...
<section id="selected-work">
  ...
  <p>A selection of recent work. The complete record is on the dedicated pages.</p>

  <ul class="compact-list">
    <li class="compact-list__item">
      <a href="https://arxiv.org/abs/2510.26239" target="_blank" rel="noopener noreferrer">A Large-Area Optical Time Projection Chamber for Hard X-ray Polarimetry with Directional Imaging of Low-Energy Electron Recoils</a> <span class="status-label">(2026, arXiv)</span>
    </li>
    <li class="compact-list__item">
  ...
  <div class="button-row" style="margin-top: var(--space-3);">
    <a href="{{ base_path }}/publications/" class="site-button site-button--secondary">All publications</a>
...
<section id="teaching-teaser">
  ...
  <p>I supervise students, teach detector laboratories, lead international schools, and give public seminars.</p>
  <a href="{{ base_path }}/teaching/" class="site-button site-button--secondary">Read more about teaching &amp; outreach</a>
</section>

<!-- Contact -->
<section id="contact" class="contact-block">
  <h2 class="section-heading">Get in touch</h2>
  <p>For collaborations, seminars, or student projects, contact me by email or through the profiles below.</p>
  <div class="button-row" style="justify-content: center;">
    <a href="mailto:{{ site.author.email }}" class="site-button site-button--primary">Email</a>
